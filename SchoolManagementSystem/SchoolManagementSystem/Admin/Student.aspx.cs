        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlGender.SelectedValue != "0")
                {
                    ...
                    DataTable dt = fn.Fetch("Select * from Student where ClassId ='" + ddlClass.SelectedValue + "' and RollNo = '" + rollNumber + "'");
                    if (dt.Rows.Count == 0)
                    {
                    ...
                    {
                        lblMsg.Text = "Entered Roll No. <b>'" + rollNumber + "'</b> already exists for selected Class!";
